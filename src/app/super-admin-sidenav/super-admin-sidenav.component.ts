...
@Component({
  selector: 'app-super-admin-sidenav',
  templateUrl: './super-admin-sidenav.component.html',
  styleUrls: ['./super-admin-sidenav.component.css'],
...
export class SuperAdminSidenavComponent {
  ...
  editReport(fetchedUserData: any) {
    ...
    this.router.navigateByUrl('/super-admin-account-information', { state: { adminData: fetchedUserData[0] } });
