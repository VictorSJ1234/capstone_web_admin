...
@Component({
  selector: 'app-edit-taskforce-profile',
  templateUrl: './edit-taskforce-profile.component.html',
  styleUrls: ['./edit-taskforce-profile.component.css', '../../assets/bootstrap/bootstrap.min.css']
})
export class EditTaskforceProfileComponent {
  adminData: any;
