...
@Component({
  selector: 'app-barangay-sidenav',
  templateUrl: './barangay-sidenav.component.html',
  styleUrls: ['./barangay-sidenav.component.css'],
  providers: [AdminRegistrationService]
})
export class BarangaySidenavComponent {
  ...
  editReport(fetchedUserData: any) {
    ...
    this.router.navigateByUrl('/barangay-admin-profile-edit', { state: { adminData: fetchedUserData[0] } });
