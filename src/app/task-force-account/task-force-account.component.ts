...
@Component({
  selector: 'app-task-force-account',
  templateUrl: './task-force-account.component.html',
  styleUrls: ['./task-force-account.component.css', '../../assets/bootstrap/bootstrap.min.css']
})
export class TaskForceAccountComponent {
  adminData: any;
