...
@Component({
  selector: 'app-super-admin-account-information',
  templateUrl: './super-admin-account-information.component.html',
  styleUrls: ['./super-admin-account-information.component.css', '../../assets/bootstrap/bootstrap.min.css']
})
export class SuperAdminAccountInformationComponent {
  adminData: any;
  ...
  onImageSelected(event: any) {
    ...
    if (file) {
      ...
      reader.onload = (e: any) => {
        ...
        this.image = e.target.result; // Set the selected image as the source for the <img> element
        this.fetchedAdminData[0].adminProfilePicture = base64Data; // Set the extracted base64 data
      };
